...
class ConvTasNet(BaseEncoderMaskerDecoder):
    ...
    def __init__(
        ...
        **fb_kwargs,
        ...
        # Shira and Karine - 21/09/21
        if fb_name == "multiphase_gammatone":
            encoder, decoder_tmp = make_enc_dec(
                fb_name,
            ...
            dec_tme_tensor = decoder_tmp.filterbank._filters
            decoder.filterbank._filters.data = dec_tme_tensor.data
        else:
