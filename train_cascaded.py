...
parser.add_argument("--exp_dir", default="exp/train_gammatone_cascaded", help="Full path to save best validation model")

parser.add_argument("--enhc_dir", default="exp/train_gammatone_enhc_both_psiv", help="path to enhancement model")

parser.add_argument("--sep_dir", default="exp/train_gammatone_sep-clean_dec_psiv", help="path to separation model")
...
def main(conf):
    ...
    trainer = pl.Trainer(
        ...
        resume_from_checkpoint = r'C:\Users\eliashivk\Documents\DSP_final_project\asteroid-master\egs\librimix\ConvTasNet\exp\train_gammatone_cascaded\checkpoints\epoch=27-step=194599.ckpt'   # Karine and Shira - 9/7/21
    )
    trainer.fit(system)
